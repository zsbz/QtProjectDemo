    ...
    , ui(new Ui::TcpServerWidget)
{
    ...
    connect(tcpServer, &QTcpServer::newConnection, this, &TcpServerWidget::slotSendMessage);
...
void TcpServerWidget::refused()
{
    tcpServer->close();
    ui->serverStatusLabel->setText(tr("对方拒绝接收！！！"));
}

void TcpServerWidget::closeEvent(QCloseEvent*) { slotServerCloseBtnClicked(); }

void TcpServerWidget::slotSendMessage()
{
    ui->serverSendBtn->setEnabled(false);
...
void TcpServerWidget::slotUpdateClientProgress(qint64 numBytes)
{
    qApp->processEvents();
...
void TcpServerWidget::slotServerOpenBtnClicked()
{
...
void TcpServerWidget::slotServerSendBtnClicked()
{
    ...
    emit signalSendFileName(theFileName);
}

void TcpServerWidget::slotServerCloseBtnClicked()
{
